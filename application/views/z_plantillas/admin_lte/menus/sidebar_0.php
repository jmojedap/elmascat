<?php
    //Clases menú
        ...
        //Datos
            ...
            $menus['admin/tablas'] = array('ajustes', 'ajustes-database');
            $menus['admin/acl_recursos'] = array('ajustes', 'ajustes-procesos');
            $menus['admin/msexcel'] = array('ajustes', 'ajustes-database');
            $menus['admin/procesos'] = array('ajustes', 'ajustes-procesos');
            ...
            <li class="treeview <?= $clases_m0['estadisticas'] ?>">
                ...
                <ul class="treeview-menu">
                    <li class="<?= $clases_m1['estadisticas-pedidos'] ?>">
                        <?= anchor("estadisticas/resumen_mes", '<i class="fa fa-shopping-cart"></i> Ventas') ?>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview <?= $clases_m0['ajustes'] ?>">
                ...
                <ul class="treeview-menu">
                    <li class="<?= $clases_m1['ajustes-parametros'] ?>">
                        <?= anchor('admin/options', '<i class="fa fa-cog"></i> Parámetros') ?>
                    </li>
                    ...
                    <li class="<?= $clases_m1['ajustes-database'] ?>">
                        <?= anchor("admin/tablas/item", '<i class="fa fa-database"></i> Base de datos') ?>
                    </li>
                    <li class="<?= $clases_m1['ajustes-procesos'] ?>">
                        <?= anchor("admin/procesos", '<i class="fa fa-server"></i> Procesos') ?>
                    </li>
                </ul>
            </li>
        </ul>
