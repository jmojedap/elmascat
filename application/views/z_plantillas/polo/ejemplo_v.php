...
<html lang="en">
    <head>
        <?php $this->load->view('plantillas/polo/head'); ?>
    </head>
    ...
    <body>
        <div class="page"> 
                ...
                <div class="header-top">
                    <div class="container">
                        <div class="row"> 
                            <!-- Header Language -->
                            <div class="col-xs-6">
                                <div class="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#"> <img src="<?= $carpeta_ejemplo ?>images/english.png" alt="language"> English <span class="caret"></span> </a>
                                    <ul class="dropdown-menu" role="menu">
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img src="<?= $carpeta_ejemplo ?>images/english.png" alt="language"> English </a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img src="<?= $carpeta_ejemplo ?>images/francais.png" alt="language"> French </a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img src="<?= $carpeta_ejemplo ?>images/german.png" alt="language"> German </a></li>
                                    </ul>
                                </div>
                ...
                <div class="header container">
                    <div class="row">
                        <div class="col-lg-2 col-sm-3 col-md-2"> 
                            <!-- Header Logo --> 
                            <a class="logo" title="Magento Commerce" href="index.html"><img alt="Magento Commerce" src="<?= $carpeta_ejemplo ?>images/logo.png"></a> 
                            <!-- End Header Logo --> 
                        </div>
                                    ...
                                    <div>
                                        <div class="top-cart-content arrow_box">
                                            ...
                                            <ul id="cart-sidebar" class="mini-products-list">
                                                <li class="item even"> <a class="product-image" href="#" title="Downloadable Product "><img alt="Downloadable Product " src="<?= $carpeta_ejemplo ?>products-images/product1.jpg" width="80"></a>
                                                ...
                                                <li class="item last odd"> <a class="product-image" href="#" title="  Sample Product "><img alt="  Sample Product " src="<?= $carpeta_ejemplo ?>products-images/product1.jpg" width="80"></a>
                                                    <div class="detail-item">
                                                        <div class="product-details"> <a href="#" title="Remove This Item" onClick="" class="glyphicon glyphicon-remove">&nbsp;</a> <a class="glyphicon glyphicon-pencil" title="Edit item" href="#">&nbsp;</a>
            ...
            <nav>
                <div class="container">
                    <div class="nav-inner">
                        <div class="logo-small"> <a class="logo" title="Magento Commerce" href="index.html"><img alt="Magento Commerce" src="<?= $carpeta_ejemplo ?>images/logo.png"></a> </div>
                        <!-- mobile-menu -->
                        ...
                        <ul id="nav" class="hidden-xs">
                                ...
                                <div class="level0-wrapper dropdown-6col">
                                    <div class="level0-wrapper2">
                                        ...
                                        <div class="nav-block nav-block-right std grid12-4">
                                            <div class="static-img-block"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/nav-img1.jpg" alt="Responsive"></a></div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="level0 nav-5 level-top first"> <a class="level-top" href="grid.html"> <span>Men</span> </a>
                                <div class="level0-wrapper dropdown-6col">
                                    ...
                                    <div class="nav-add">
                                        <div class="push_item">
                                            <div class="push_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/menu-sunglass.png" alt="sunglass"></a></div>
                                        </div>
                                        <div class="push_item">
                                            <div class="push_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/menu-sunglass.png" alt="watch"></a></div>
                                        </div>
                                        <div class="push_item">
                                            <div class="push_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/menu-sunglass.png" alt="jeans"></a></div>
                                        </div>
                                        <div class="push_item">
                                            <div class="push_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/menu-sunglass.png" alt="shoes"></a></div>
                                        </div>
                                        <div class="push_item push_item_last">
                                            <div class="push_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/menu-sunglass.png" alt="swimwear"></a></div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-custom-link level0 level-top parent"> <a class="level-top" href="#"><span>Custom</span></a>
                                <div class="level0-wrapper custom-menu">
                                    <div class="header-nav-dropdown-wrapper clearer">
                                        <div class="grid12-5">
                                            <div class="custom_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/custom-img1.jpg" alt="custom img1"></a></div>
                                        ...
                                        <div class="grid12-5">
                                            <div class="custom_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/custom-img2.jpg" alt="custom img2"></a></div>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                                            <button type="button" title="Add to Cart" class="learn_more_btn"><span>Learn More</span></button>
                                        </div>
                                        <div class="grid12-5">
                                            <div class="custom_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/custom-img3.jpg" alt="custom img3"></a></div>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                                            <button type="button" title="Add to Cart" class="learn_more_btn"><span>Learn More</span></button>
                                        </div>
                                        <div class="grid12-5">
                                            <div class="custom_img"><a href="#"><img src="<?= $carpeta_ejemplo ?>images/custom-img4.jpg" alt="custom img4"></a></div>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                                            <button type="button" title="Add to Cart" class="learn_more_btn"><span>Learn More</span></button>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-sm-12 col-md-8 wow bounceInUp animated">
                            <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
                                <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                                    <ul>
                                        <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?= $carpeta_ejemplo ?>images/slider_img_2.jpg'><img src='<?= $carpeta_ejemplo ?>images/slide-img1.jpg' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
                                        ...
                                        <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?= $carpeta_ejemplo ?>images/slider_img_2.jpg' class="black-text"><img src='<?= $carpeta_ejemplo ?>images/slide-img2.jpg'  data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
                        ...
                        <aside class="col-xs-12 col-sm-12 col-md-4 wow bounceInUp animated">
                            <div class="RHS-banner">
                                <div class="add"><a href="#"><img alt="banner-img" src="<?= $carpeta_ejemplo ?>images/rhs-banner.jpg"></a>
                                    ...
                                    <div class="slider-items slider-width-col4"> 
                                        ...
                                        <div class="item">
                                            <div class="col-item">
                                                ...
                                                <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="<?= $carpeta_ejemplo ?>products-images/product1.jpg" class="img-responsive" alt="product-image" /> </a>
                                        ...
                                        <div class="item">
                                            <div class="col-item">
                                                ...
                                                <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="<?= $carpeta_ejemplo ?>products-images/product1.jpg" class="img-responsive" alt="a" /> </a>
                                                    <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="#" title="Add to cart">
                                                            <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                                                        </a> <a class="quick-view" href="quick_view.html">
                                                            <div><i class="icon-eye-open"></i><span>Quick view</span></div>
                                        ...
                                        <div class="item">
                                            <div class="col-item">
                                                <div class="sale-label sale-top-right">Sale</div>
                                                <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="<?= $carpeta_ejemplo ?>products-images/product1.jpg"> </a>
                                                    <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="#" title="Add to cart">
                                                            <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                                                        </a> <a class="quick-view" href="quick_view.html">
                                                            <div><i class="icon-eye-open"></i><span>Quick view</span></div>
            ...
            <div class="offer-banner-section wow bounceInUp animated">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-xs-12 col-sm-4"><a href="#"><img alt="offer banner1" src="<?= $carpeta_ejemplo ?>images/offer-banner1.jpg"></a>
                            <div class="overlay"><a class="info" href="#">Learn More</a></div>
                        </div>
                        <div class="col-lg-4 col-xs-12 col-sm-4"><a href="#"><img alt="offer banner2" src="<?= $carpeta_ejemplo ?>images/offer-banner1.jpg"></a>
                            <div class="overlay"><a class="info" href="#">Learn More</a></div>
                        </div>
                        <div class="col-lg-4 col-xs-12 col-sm-4"><a href="#"><img alt="offer banner3" src="<?= $carpeta_ejemplo ?>images/offer-banner1.jpg"></a>
                            <div class="overlay"><a class="info" href="#">Learn More</a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="promo-banner-section container wow bounceInUp animated">
                <div class="row">
                    <div class="col-lg-12"> <img alt="promo-banner3" src="<?= $carpeta_ejemplo ?>images/jewelry-banner.jpg"></div>
                </div>
            </div>
            ...
            <section class="latest-blog container wow bounceInUp animated">
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="blog-img"> <img src="<?= $carpeta_ejemplo ?>images/blog-img1.jpg" alt="Image">
                ...
                <div class="footer-middle container">
                    <div class="row">
                        <div class="col-md-3 col-sm-4">
                            <div class="footer-logo"><a href="index.html" title="Logo"><img src="<?= $carpeta_ejemplo ?>images/logo.png" alt="logo"></a></div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus diam arcu. </p>
                            <div class="payment-accept">
                                <div><img src="<?= $carpeta_ejemplo ?>images/payment-1.png" alt="payment"> <img src="<?= $carpeta_ejemplo ?>images/payment-2.png" alt="payment"> <img src="<?= $carpeta_ejemplo ?>images/payment-3.png" alt="payment"> <img src="<?= $carpeta_ejemplo ?>images/payment-4.png" alt="payment"></div>
                            </div>
                        </div>
        ...
        <!-- JavaScript --> 
        <script type="text/javascript" src="<?= $carpeta_tema ?>js/bootstrap.min.js"></script> 
