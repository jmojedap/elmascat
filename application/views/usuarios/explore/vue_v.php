...
// Variables
//-----------------------------------------------------------------------------
    var arr_roles = <?= json_encode($arr_roles) ?>;
    var arr_genders = <?= json_encode($arr_genders) ?>;
    var arr_id_number_types = <?= json_encode($arr_id_number_types) ?>;
