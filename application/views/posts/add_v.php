<?php 
    $options_type = $this->Item_model->options('categoria_id = 33', 'Tipo de post');
?>
        ...
        <div class="card-body">
            <form id="add_form" accept-charset="utf-8" @submit.prevent="send_form">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input
                            id="field-nombre_post" class="form-control"
                            name="nombre_post"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <?php echo form_dropdown('tipo_id', $options_type, '', 'class="form-control" required v-model="form_values.type"') ?>
                    </div>
                </div>
