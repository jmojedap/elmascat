...
<div id="recoveryApp" class="center_box_320 text-center">
        ...
        <form accept-charset="utf-8" method="POST" id="recoveryForm" @submit.prevent="handleSubmit">
            <fieldset v-bind:disabled="loading">
                ...
                <div class="mb-3">
                    ...
                    <input
                        name="email" type="email" class="form-control form-control-lg input-lg" required
    ...
    <div v-show="app_status == 'sent'" class="my-2">
        ...
        <p>
            Enviamos un enlace (link) al correo electrónico
