<meta charset="UTF-8">
        ...
        <!-- Tema Librería -->
        <link href="<?= URL_RESOURCES ?>templates/libreria/style.css" rel="stylesheet" type="text/css" />
        <link href="<?= URL_RESOURCES ?>templates/libreria/mobile.css" rel="stylesheet" type="text/css" />
