...
var startCategory = categories.find(category => category.id_interno == 0)
...
var manageItemsApp = new Vue({
    ...
    methods: {
        ...
        getItems: function (){
            axios.get(url_api + 'items/get_list/' + this.currCategory.id_interno)
            .then(response => {
                this.items = response.data;
                history.pushState(null, null, url_api + 'items/manage/' + this.currCategory.id_interno);
