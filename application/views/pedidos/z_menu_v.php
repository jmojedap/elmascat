...
<?php
    ...
    //Atributos de los elementos del menú
        ...
        $arr_menus['test'] = array(
            'icono' => '',
            'texto' => 'Test',
            'link' => "pedidos/test/confirmation/{$row->id}",
            'atributos' => 'title="Test de confirmación y respuesta"'
        );
    ...
    //Elementos de menú según el rol del visitante
        $elementos_rol[0] = array('explorar', 'ver', 'pol', 'extras', 'test', 'editar');
        $elementos_rol[1] = array('explorar', 'ver', 'pol', 'extras', 'test', 'editar');
