...
//-----------------------------------------------------------------------------
    ...
    new Vue({
        ...
        methods: {
            get_list: function(){
                axios.post(URL_API2 + 'pedidos/extras_get/' + this.pedido_id, $('#search_form').serialize())
                .then(response => {
            ...
            send_form: function(){
                axios.post(URL_API2 + 'pedidos/extras_save/', $('#extra_form').serialize())
                .then(response => {
            ...
            delete_element: function() {
                axios.get(URL_API2 + 'pedidos/extras_delete/' + this.pedido_id + '/' + this.row_id)
                .then(response => {
                    console.log(response.data);
                    if ( response.data.status == 1 )
                    {
