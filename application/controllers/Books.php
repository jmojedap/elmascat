...
//-----------------------------------------------------------------------------
    ...
    function rename_pages($book_code = '117667013245')
    {
        $this->load->helper('file');
        ...
        {
            $new_name = str_replace('Noviembre','',$file);
    ...
    function create_read($book_code = '117667013245')
    {
        $this->load->helper('file');
        $folder = PATH_CONTENT . "books/{$book_code}/org/";
        $pages = get_filenames($folder);
    ...
    function create_drive($book_code = '117667013245')
    {
        $this->load->helper('file');
        $folder = PATH_CONTENT . "books/{$book_code}/org/";
        $pages = get_filenames($folder);
    ...
    function create_mini($book_code = '117667013245')
    {
        $this->load->helper('file');
        $folder = PATH_CONTENT . "books/{$book_code}/read/";
        $pages = get_filenames($folder);
