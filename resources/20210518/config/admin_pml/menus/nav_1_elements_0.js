        ...
        subelements: [
            {
                ...
                sections: ['estadisticas/resumen_dia', 'estadisticas/resumen_mes', 'estadisticas/ventas_departamento', 'estadisticas/meta_anual', 'estadisticas/productos_top', 'estadisticas/efectividad', 'estadisticas/ventas_categoria'],
                anchor: true,
            }
        ],
        sections: []
        ...
        subelements: [
            {
                ...
                cf: 'admin/options',
                sections: ['admin/options', 'admin/processes', 'admin/colors']
            },
            {
